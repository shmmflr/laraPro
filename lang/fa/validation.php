...
return [
    ...
    'attributes' => [
        ...
        'postal_code' => 'کد پستی',
        'seo_name' => 'نام سئو',
        'company_img' => 'عکس شرکت',
        'company_id' => 'شناسه شرکت',
        'type_of_activity' => 'نوع فعالیت',
        'place_number' => 'ترتیب نمایش',
        'product_id' => 'محصول',
        'cat_id' => 'دسته بندی',
        'product_name' => 'نام محصول',
        'product_details' => 'نام انگلیسی محصول',
        'subcat_id' => 'زیر دسته بندی',
        'product_img' => 'عکس محصول',
        'technical_description' => 'توضیحات محصول',
        'brand_img' => 'عکس برند',
        'subcat_name' => 'زیر دسته بندی',
        "p_img" => 'عکس محصول',
        "number" => 'شماره تماس',
        "position" => 'جایگاه شغلی',
        "temp_content" => 'توضیحات صفحه قالب',
        "temp_title" => 'عنوان صفحه قالب',
        "temp_name" => 'بخش مربوط به قالب',
        "l_name" => 'نام',
        "f_name" => 'نام خانوادگی',
